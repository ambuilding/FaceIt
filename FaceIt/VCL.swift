...
func getFaceMVCinstanceCount() -> Int {
    faceMVCinstanceCount += 1
    return faceMVCinstanceCount
}

private var emotionsMVCinstanceCount = 0
func getEmotionsMVCinstanceCount() -> Int {
    emotionsMVCinstanceCount += 1
    return emotionsMVCinstanceCount
}
...
// extension is basically a way to add methods to a given class
...
extension FaceViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        logVCL("viewDidLoad(animated = \(animated))")
    }
    ...
    override func viewWillTransitionToSize(size: CGSize, withTransitionCoordinator coordinator: UIViewControllerTransitionCoordinator) {
        ...
        coordinator.animateAlongsideTransition({ (context: UIViewControllerTransitionCoordinatorContext!) -> Void in
            self.logVCL("animateAlongsideTransition")
